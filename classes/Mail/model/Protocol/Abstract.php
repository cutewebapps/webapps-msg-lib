...
abstract class Mail_Protocol_Abstract
{
    /**
    ...
    protected function _connect($remote)
    {
        ...
        if ($this->_socket === false) {
             ...
             */
            throw new Mail_Protocol_Exception($errorStr);
        }
        ...
        if (($result = stream_set_timeout($this->_socket, self::TIMEOUT_CONNECTION)) === false) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('Could not set stream timeout');
        }
    ...
    protected function _send($request)
    {
        if (!is_resource($this->_socket)) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('No connection has been established to ' . $this->_host);
        }
        ...
        if ($result === false) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('Could not send request to ' . $this->_host);
        }
    ...
    protected function _receive($timeout = null)
    {
        ...
        if (!empty($info['timed_out'])) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception($this->_host . ' has timed out');
        }
        ...
        if ($reponse === false) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('Could not read from ' . $this->_host);
        }
    ...
    protected function _expect($code, $timeout = null)
    {
        ...
        if ($errMsg !== '') {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception($errMsg);
        }
