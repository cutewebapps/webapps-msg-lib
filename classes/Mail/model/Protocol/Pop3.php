...
class Mail_Protocol_Pop3
{
    ...
    public function sendRequest($request)
    {
        ...
        if (!$result) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('send failed - connection closed?');
        }
    }
    ...
    public function readResponse($multiline = false)
    {
        ...
        if (!is_string($result)) {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('read failed - connection closed?');
        }
        ...
        if ($status != '+OK') {
             ...
             * @see Mail_Protocol_Exception
             */
            throw new Mail_Protocol_Exception('last request failed. status: '.$status.', message: '. $message );
        }
    ...
    public function top($msgno, $lines = 0, $fallback = false)
    {
        if ($this->hasTop === false) {
            if ($fallback) {
                 ...
                 * @see Mail_Protocol_Exception
                 */
                throw new Mail_Protocol_Exception('top not supported and no fallback wanted');
            }
        }
        $this->hasTop = true;
