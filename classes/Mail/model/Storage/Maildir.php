...
class Mail_Storage_Maildir extends Mail_Storage_Abstract
{
    /**
     * used message class, change it in an extened class to extend the returned message class
     * @var string
     */
    protected $_messageClass = 'Mail_Message_File';
     ...
     * @var array
     */
    protected static $_knownFlags = array('D' => Mail_Storage::FLAG_DRAFT,
                                          'F' => Mail_Storage::FLAG_FLAGGED,
                                          'P' => Mail_Storage::FLAG_PASSED,
                                          'R' => Mail_Storage::FLAG_ANSWERED,
                                          'S' => Mail_Storage::FLAG_SEEN,
                                          'T' => Mail_Storage::FLAG_DELETED);
    ...
    protected function _getFileData($id, $field = null)
    {
        if (!isset($this->_files[$id - 1])) {
             ...
             */
            throw new Mail_Storage_Exception('id does not exist');
        }
        ...
        if (!isset($this->_files[$id - 1][$field])) {
             ...
             * @see Mail_Storage_Exception
             */
            throw new Mail_Storage_Exception('field does not exist');
        }
     ...
     * @return Mail_Message_File
     * @throws Mail_Storage_Exception
     */
    public function getMessage($id)
    {
        // TODO that's ugly, would be better to let the message class decide
        if (strtolower($this->_messageClass) == 'Mail_message_file' || is_subclass_of($this->_messageClass, 'Mail_message_file')) {
    ...
    public function __construct($params)
    {
        ...
        if (!$this->_isMaildir($params->dirname)) {
             ...
             * @see Mail_Storage_Exception
             */
            throw new Mail_Storage_Exception('invalid maildir given');
        }
    ...
    protected function _openMaildir($dirname)
    {
        ...
        if (!$dh) {
             ...
             * @see Mail_Storage_Exception
             */
            throw new Mail_Storage_Exception('cannot open maildir');
        }
        ...
        if ($dh) {
            $this->_getMaildirFiles($dh, $dirname . '/new/', array(Mail_Storage::FLAG_RECENT));
            closedir($dh);
        } else if (file_exists($dirname . '/new/')) {
            /**
             * @see Mail_Storage_Exception
             */
            throw new Mail_Storage_Exception('cannot read recent mails in maildir');
        }
    }
    ...
    public function removeMessage($id)
    {
         ...
         * @see Mail_Storage_Exception
         */
        throw new Mail_Storage_Exception('maildir is (currently) read-only');
    }
