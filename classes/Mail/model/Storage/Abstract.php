...
abstract class Mail_Storage_Abstract implements Countable, ArrayAccess, SeekableIterator
{
    /**
    ...
    public function __get($var)
    {
         ...
         */
        throw new Mail_Storage_Exception($var . ' not found');
    }
     ...
     */
      ...
      *
      * @param    int $id
      * @return   Mail_Message message object
      */
     ...
     public function offsetSet($id, $value)
     {
         ...
         * @see Mail_Storage_Exception
         */
        throw new Mail_Storage_Exception('cannot write mail messages via array access');
     }
      ...
      * Iterator::current()
      *
      * @return   Mail_Message current message
      */
