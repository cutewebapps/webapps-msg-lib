...
class Mail_Storage_Pop3 extends Mail_Storage_Abstract
{
    /**
     * protocol handler
     * @var null|Mail_Protocol_Pop3
     */
    protected $_protocol;
    ...
    public function getRawContent($id, $part = null)
    {
        ...
        Mime_Decode::splitMessage($content, $null, $body);
        return $body;
    }
    ...
    public function __construct($params)
    {
        ...
        if ($params instanceof Mail_Protocol_Pop3) {
        ...
        $this->_protocol = new Mail_Protocol_Pop3();
     ...
     *
     * @see Mail_Storage_Abstract:__get()
     * @param  string $var
     * @return string
     * @throws Mail_Storage_Exception
     */
