...
class Mail_Storage_Mbox extends Mail_Storage_Abstract
{
    /**
    ...
    public function __construct($params)
    {
        ...
        if (!isset($params->filename) /* || Zend_Loader::isReadable($params['filename']) */) {
             ...
             * @see Mail_Storage_Exception
             */
            throw new Mail_Storage_Exception('no valid filename given in params');
        }
    ...
    protected function _openMboxFile($filename)
    {
        ...
        if (!$this->_fh) {
             ...
             * @see Mail_Storage_Exception
             */
            throw new Mail_Storage_Exception('cannot open mbox file');
        }
        ...
        if (!$this->_isMboxFile($this->_fh, false)) {
             ...
             * @see Mail_Storage_Exception
             */
            new Mail_Storage_Exception('file is not a valid mbox format');
        }
    ...
    public function removeMessage($id)
    {
         ...
         * @see Mail_Storage_Exception
         */
        throw new Mail_Storage_Exception('mbox is read-only');
    }
