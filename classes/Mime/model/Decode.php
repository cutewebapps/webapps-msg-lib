...
class Mime_Decode
{
     ...
     * @throws Mime_Exception
     */
    public static function splitMessageStruct($message, $boundary, $EOL = Mime_Const::LINEEND)
    {
     ...
     * @return null
     */
    public static function splitMessage($message, &$headers, &$body, $EOL = Mime_Const::LINEEND)
    {
    ...
    public static function splitHeaderField($field, $wantedPart = null, $firstName = 0)
    {
        ...
        if (!preg_match_all('%([^=\s]+)\s*=\s*("[^"]+"|[^;]+)(;\s*|$)%', $field, $matches)) {
            throw new Mime_Exception('not a valid header field');
        }
